...
export default function GoogleButton({ style, onClick }: GoogleButtonProps) {
    return (
        <button
        ...
        >
            ...
            <span className="text-md text-google-text-gray tracking-wider font-semibold">Sign in with Google</span>
        </button>
    )
}